...
*DisableSandbox*::
	Disable the default sandbox applied to the process downloading files. Use
	this if you are compiling on a more recent kernel than the one you are
	actually using and have issues downloading files.
